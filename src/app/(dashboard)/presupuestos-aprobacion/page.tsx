...
export default function PresupuestosAprobacionPage() {
  ...
  const [filtroTipoAprobacion, setFiltroTipoAprobacion] = useState<string>('');
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-[var(--text-secondary)]">
            Gestión de aprobaciones para pasar de Licitación a Contractual y de Contractual a Meta
          </p>
        </div>
      </div>
            ...
            <div className="flex-1">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  onChange={(e) => setFiltroTipoAprobacion(e.target.value)}
